...
function Skills() {
  ...
  return (
    <div className='bg-primaryBlue h-auto overflow-hidden lg:px-20 '>
      ...
      <h1 className='text-black font-semibold text-cen
      text-size-400 lg:text-size-500 tracking-wide'>Dev-tools & Languages</h1>
      <div className="w-full grid xl:grid-cols-7 gap-5 grid-cols-3 sm:grid-cols-4  ">
      {
